...
private _shelfW1=createVehicle["Land_ShelvesWooden_F",[0,0,0]];
private _shelfW2=createVehicle["Land_ShelvesWooden_F",[0,0,0]];
private _shelfW3=createVehicle["Land_ShelvesWooden_F",[0,0,0]];
private _shelfW4=createVehicle["Land_ShelvesWooden_F",[0,0,0]];
private _rack=createVehicle["Land_Metal_wooden_rack_F",[0,0,0]];
private _notepad=createSimpleObject["Land_Notepad_F",[0,0,0]];
private _oldDesk=createVehicle["OfficeTable_01_old_F",[0,0,0]];
...
_shelfW1 addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_shelfW2 addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_shelfW3 addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_shelfW4 addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_rack addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_oldDesk addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_sacks2 addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
_boxes addAction ["<img size='2' image='res\search.paa'/>", "search.sqf"];
